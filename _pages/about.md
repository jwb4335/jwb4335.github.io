...
- 2026.07.20: <span style="color: red;">**New version**</span> of [Information and Preferences in Shareholder Voting](<{{ site.baseurl }}/files/papers/strategic_voting.pdf>){:target="_blank"}{:rel="noopener noreferrer"}
    - Presenting at the [Vienna Festival of Finance Theory](https://sites.google.com/view/vienna-festival-of-finance/startseite){:target="_blank"}{:rel="noopener noreferrer"}, the [Oktoberfest Finance Conference](https://miamioh.edu/fsb/departments/finance/oktoberfest-conference.html){:target="_blank"}{:rel="noopener noreferrer"}, and the [Northern Finance Association](https://northernfinanceassociation.org/conference/){:target="_blank"}{:rel="noopener noreferrer"}
    - Presented at [FIRS 2026](https://firsociety.org/conference/2026-conference/){:target="_blank"}{:rel="noopener noreferrer"}
- <span style="color: red;">**New version**</span> of [Human Capital, Competition and Mobility in the Managerial Labor Market](<{{ site.baseurl }}/files/papers/ceo_human_capital.pdf>){:target="_blank"}{:rel="noopener noreferrer"} coming very soon!
